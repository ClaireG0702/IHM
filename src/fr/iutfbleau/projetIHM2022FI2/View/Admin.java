...
import fr.iutfbleau.projetIHM2022FI2.Controller.ListenerGroupe;
...
/**
 * La classe <code>Admin</code> est la fenêtre principale avec laquelle interagit l'admin
 * 
 *  
 * @version 1.1
...
public class Admin extends JFrame{
    ...
    private JButton addGroup = new JButton("Nouveau groupe");
    private JButton rename = new JButton("Renommer un groupe");
	private JButton delete = new JButton("Supprimer un groupe");
    ...
    public Admin() {
        ...
        AfficheArbre arbreA = new AfficheArbre(groupFactory, promo, 2);
        ...
        cont.weightx = 2.0f;
        cont.weighty = 5.0f;
        listGroup.setBackground(Color.DARK_GRAY);
        ...
        cont.weightx = 2.0f;
        cont.weighty = 5.0f;
        listAll.setBackground(Color.DARK_GRAY);
        ...
        /*
         * Contraintes, ajout + parametres des boutons
         */
        cont.gridx = 0;
        cont.gridy = 5;
        cont.gridwidth = 2;
        ...
        cont.weightx = 2.0f;
        cont.weighty = 1.0f;
        addGroup.setBackground(Color.LIGHT_GRAY);
        addGroup.setBorder(BorderFactory.createLineBorder(Color.black));
    	addGroup.addActionListener(new ListenerGroupe(groupFactory, arbreA, 1));
        panel.add(addGroup, cont);
        ...
        cont.weightx = 2.0f;
        cont.weighty = 1.0f;
        rename.setBackground(Color.LIGHT_GRAY);
        rename.setBorder(BorderFactory.createLineBorder(Color.black));
    	rename.addActionListener(new ListenerGroupe(groupFactory, arbreA, 2));
        panel.add(rename, cont);
    	...
    	delete.addActionListener(new ListenerGroupe(groupFactory, arbreA, 3));
        panel.add(delete, cont);
